      ...
      <DrawerContent className="top-0">
        <ScrollArea className="w-full overflow-y-auto flex flex-wrap justify-center gap-6 mt-3">
          ...
          <DrawerFooter className="w-full border-t">
            <DrawerClose>
              <Button className="w-[90%] bg-destructive dark:bg-secondary text-primary text-[1rem] hover:text-foreground dark:hover:bg-background dark:text-card-foreground">CLOSE</Button>
            </DrawerClose>
          </DrawerFooter>
