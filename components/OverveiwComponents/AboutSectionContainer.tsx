...
export type AboutSectionType = "vision" | "limitations" | "next-step" | "methods";

const AboutSectionContainer = () => {
    const [currentSection, setCurrentSection] = React.useState<AboutSectionType>("vision");
    ...
    return (
        <div className="flex flex-row items-center justify-center gap-4 p-4 lg:gap-8 lg:p-0 box-border max-w-screen">
            <AboutNav currentSection={currentSection} setCurrentSection={setCurrentSection} />
            <div>
                {renderSection()}
            </div>
        </div>
