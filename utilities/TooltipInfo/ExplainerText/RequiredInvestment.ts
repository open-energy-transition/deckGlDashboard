...
export const RequiredInvestment_info: RequiredInvestment_info_type = {
  ...
  definition:
    "A modeling output which represents an annualised value of capital expenditures needed to expand the existing infrastructure to meet the electricity demand in a cost-optimal way satisfying the net-zero constraint",
  unit: "Billion €",
  source:
